...
dbconns.sort.each_with_index.map do |dbconn, index|
  ...
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:id] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:jdbc] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:host] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:port] = "3306"
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:db_name] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:user] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:password] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:initialsize] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:maxactive] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:maxidle] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:minidle] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:maxwait] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:validationquery] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:testonborrow] = ""
  default[:np_galaxy_cookbook][:tomcat_xml][dbconn][:testwhileidle] = ""
end

default[:np_galaxy_cookbook][:tomcat][:contexts_dir] = "/contexts"
default[:np_galaxy_cookbook][:tomcat_xml][:logs][:requestlog_name] = ""
default[:np_galaxy_cookbook][:tomcat_xml][:logs][:serverlog_name] = ""
